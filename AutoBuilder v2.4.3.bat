...
SET package=spigotmc
SET file=spigot
SET name=Spigot
SET name2=Spigot and CraftBukkit
call :setESC
ECHO.
...
ECHO.
ECHO %ESC%[36mBuild the org.%package%.%file% jars 1.17-1.8?%ESC%[0m
...
if not '%errorlevel%' == '0' (
    ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.17 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.16.5.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.16.5 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.16.3.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.16.3 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.16.1.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.16.1 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.15.2.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.15.2 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.14.4.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.14.4 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.13.2.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.13.2 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.12.2.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.12.2 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.11.2.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.11.2 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.10.2.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.10.2 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.9.4.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.9.4 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
ECHO %ESC%[40;37m
if exist ./product/%file%-1.8.8.jar (
	ECHO.
...
if not '%errorlevel%' == '0' (
	ECHO %ESC%[40;37m
	ECHO -------------------------------
	ECHO ^|%ESC%[1m%ESC%[31m ERROR: %ESC%[1m%ESC%[91mBUILDING %name2% 1.8.8 HAS FAILED^^! %ESC%[0m^|
	ECHO -------------------------------
	echo.
	TIMEOUT /T 15
)
